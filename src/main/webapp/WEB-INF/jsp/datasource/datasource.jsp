              ...
              <tbody>
                  <c:forEach items="${models}" var="model">
                    <tr id="${model.id}">
                        ...
                        <td class="td-sm">${model.format}</td>
                     </tr>
                 </c:forEach>
             </tbody>
         </table>
      ...
      <div class="modal-dialog" style="max-width: 50%; margin-top:120px; margin-left: 350px;">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form:form method="POST" id="uploadForm" enctype="multipart/form-data" action="/admin/datasource/upload" class="handle-upload" modelAttribute="uploadForm">
