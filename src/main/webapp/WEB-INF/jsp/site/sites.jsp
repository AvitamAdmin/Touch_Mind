         ...
         <table id="tableData" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" data-tableName="Stock Data">
              ...
              <thead>
                    <tr>
                        ...
                        <th class="th-sm">Affiliate Name</th>
                        <th class="th-sm">Site Channel</th>
              ...
              <tbody>
                  <c:forEach items="${models}" var="model">
                    <tr id="${model.id}">
                        ...
                        <td class="td-sm">${model.affiliateId}</td>
                        <td class="td-sm">${model.affiliateName}</td>
                        <td class="td-sm">${model.siteChannel}</td>
                        <c:choose>
      ...
      <div class="modal-dialog" style="max-width: 50%; margin-top:120px; margin-left: 350px;">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form:form method="POST" id="uploadForm" enctype="multipart/form-data" action="/admin/site/upload" class="handle-upload" modelAttribute="uploadForm">
