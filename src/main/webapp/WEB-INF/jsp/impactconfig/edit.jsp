                       ...
                       <c:forEach items="${labels}" var="child">
                           <c:choose>
                               <c:when test="${fn:contains( label.labels, child ) }">
                                 <option value="${fn:replace(child,"'","")}" selected>${fn:replace(child,"'","")}</option>
                               </c:when>
                               <c:otherwise>
                                  <option value="${fn:replace(child,"'","")}" >${fn:replace(child,"'","")}</option>
                               </c:otherwise>
                           </c:choose>
                       </c:forEach>
                    </select>
