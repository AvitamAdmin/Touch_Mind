         ...
         <table id="tableData" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" data-tableName="Stock Data">
              ...
              <thead>
                    <tr>
                      ...
                      <th class="th-sm">Interface</th>
                      <th class="th-sm">Subsidiary</th>
                      <th class="th-sm">Data Relation</th>
              ...
              <tbody>
                  <c:forEach items="${models}" var="model">
                     <tr id="${model.id}">
                        ...
                        <td class="td-sm">${model.sourceTargetId}</td>
                        <td class="td-sm">
                            <c:forEach items="${model.subsidiaries}" var="child">
                                 ${child.identifier},
                            </c:forEach>
                        </td>
                        <td class="td-sm">${model.dataRelation}</td>
      ...
      <div class="modal-dialog" style="max-width: 50%; margin-top:120px; margin-left: 350px;">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form:form method="POST" id="uploadForm" enctype="multipart/form-data" action="/admin/mapping/upload" class="handle-upload" modelAttribute="uploadForm">
