          ...
          <tbody>
              <c:forEach items="${models}" var="model">
                <tr id="${model.id}">
                    ...
                    <td class="td-sm"> <c:forEach items="${model.subsidiaries}" var="child">
                       ${child},
                     </c:forEach></td>
                 </tr>
      ...
      <div class="modal-dialog" style="max-width: 50%; margin-top:120px; margin-left: 350px;">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form:form method="POST" id="uploadForm" enctype="multipart/form-data" action="/admin/action/upload" class="handle-upload" modelAttribute="uploadForm">
