...
<div class="main-content collapsed" id="collapseMedia">
<div class="row">
    <div class="col-sm-12">
        <p style="font-size:20px;font-weight:bolder;">Media</p>
    </div>
</div>
  <div class="row">
    <div class="col-sm-12">
         <table id="tableData2media" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" data-tableName="Stock Data">
...
<%@ include file="tableActions1edit.jsp" %>