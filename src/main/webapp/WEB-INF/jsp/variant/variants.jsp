         ...
         <table id="tableData" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" data-tableName="Stock Data">
              ...
              <thead>
                    <tr>
                      ...
                      <th class="th-sm">externalProductUrl</th>
                    </tr>
              </thead>
              <tbody>
                  <c:forEach items="${models}" var="model">
                    <tr id="${model.id}">
                        ...
                        <td class="td-sm">${model.model.identifier}</td>
                        <td class="td-sm">${model.category.identifier}</td>
                        <td class="td-sm">
                        <c:forEach items="${model.subsidiaries}" var="child">
                             ${child.identifier},
                        </c:forEach></td>
                        <td class="td-sm">${model.externalProductUrl}</td>
                     </tr>
                 </c:forEach>
             </tbody>
         </table>
...
<div id="myModalUpload" class="modal fade" tabindex="-1">
      <div class="modal-dialog" style="max-width: 50%; margin-top:120px; margin-left: 350px;">
            ...
            <div class="modal-body">
               <form:form method="POST" id="uploadForm" enctype="multipart/form-data" action="/admin/variant/upload" class="handle-upload" modelAttribute="uploadForm">
