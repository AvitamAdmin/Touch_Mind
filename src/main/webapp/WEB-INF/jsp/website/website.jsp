        ...
        <div class="col-sm-12">
            <table id="tableData" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" data-tableName="Dashboard profiles">
                ...
                <tr>
                    ...
                    <th class="th-sm">qaResultReportStartDate</th>
                    <th class="th-sm">qaResultReportEndDate</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${models}" var="model">
                    <tr id="${model.id}">
                        ...
                        <td class="td-sm">${model.qaResultReportStartDate}</td>
                        <td class="td-sm">${model.qaResultReportEndDate}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
