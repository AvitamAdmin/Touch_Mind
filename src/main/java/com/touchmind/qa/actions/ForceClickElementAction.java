...
public class ForceClickElementAction implements ElementActionService {
    ...
    public ActionResult performAction(ActionRequest actionRequest) {
        ...
        qaLocatorResultReport = qaLocatorResultReport.getQaLocatorResultReport(actionRequest.getQaTestResultId(), testLocator.getIdentifier(), testLocator.getDescription(), media != null ? media.getPath() : null, Status.INFO, null, ActionType.FORCE_CLICK);
