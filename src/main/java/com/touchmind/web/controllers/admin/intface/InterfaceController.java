...
public class InterfaceController extends BaseController {
    ...
    public @ResponseBody NodeDto getByRecordId(@RequestParam("recordId") String recordId) {
        return modelMapper.map(nodeRepository.findByRecordId(recordId), NodeDto.class);
    }
