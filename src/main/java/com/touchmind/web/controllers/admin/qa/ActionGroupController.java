...
public class ActionGroupController extends BaseController {
    ...
    public @ResponseBody LocatorsGroupPriorityDto getByRecordId(@RequestParam("recordId") String recordId) {
        return modelMapper.map(locatorsGroupPriorityRepository.findByRecordId(recordId), LocatorsGroupPriorityDto.class);
    }
