package com.cheil.qa.framework;

import com.aventstack.extentreports.ExtentReports;
import com.aventstack.extentreports.reporter.ExtentSparkReporter;
import com.aventstack.extentreports.reporter.configuration.ExtentSparkReporterConfig;
import com.aventstack.extentreports.reporter.configuration.ViewName;
import com.cheil.qa.utils.TestDataUtils.Field;
...
public class QaConfig {
    ...
    public TestNG xmlSuite(String testData) {
        ...
        testClasses.add(new XmlClass("com.cheil.qa.testplans.CoreTest"));
    ...
    public FluentWait<WebDriver> fluentWait(WebDriver driver) {
        return new FluentWait<>(driver)
                .withTimeout(Duration.ofSeconds(webDriverWaitTimeoutSeconds))
                .pollingEvery(Duration.ofSeconds(webDriverWaitPollingSeconds))
