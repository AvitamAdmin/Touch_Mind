...
import com.touchMind.qa.crawler.selector.actions.CrawlerLocatorAction;
import com.touchMind.qa.crawler.selector.actions.CrawlerLocatorType;
...
public class CrawlerLocatorFactory {
    ...
    public static final String FORCE_CLICK = "forceclick";
    ...
    private CrawlerElementAttributes constructCrawlerElement(String element, NavigationLink defaultLocator, String defaultMethodType) {
        ...
        crawlerElementAttributes.setRootLocator(defaultLocator.getSelector());
        ...
        switch (actionType) {
            case CLICK:
                ...
                break;
            case FORCE_CLICK:
                crawlerElementAttributes.setCrawlerLocatorType(CrawlerLocatorType.CRAWLER_FORCE_CLICK_ACTION);
                break;
            case SKIP:
