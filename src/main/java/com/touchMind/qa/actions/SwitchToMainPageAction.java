...
public class SwitchToMainPageAction implements ElementActionService {
    ...
    public ActionResult performAction(ActionRequest actionRequest) {
        ...
        qaLocatorResultReport = qaLocatorResultReport.getQaLocatorResultReport(actionRequest.getQaTestResultId(), testLocator.getIdentifier(), testLocator.getShortDescription(), media != null ? media.getPath() : null, Status.INFO, null, ActionType.SWITCH_TO_MAIN_PAGE);
