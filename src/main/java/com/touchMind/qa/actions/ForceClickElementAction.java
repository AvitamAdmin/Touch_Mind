...
public class ForceClickElementAction implements ElementActionService {
    ...
    public ActionResult performAction(ActionRequest actionRequest) {
        ...
        qaLocatorResultReport = qaLocatorResultReport.getQaLocatorResultReport(actionRequest.getQaTestResultId(), testLocator.getIdentifier(), testLocator.getShortDescription(), media != null ? media.getPath() : null, Status.INFO, null, ActionType.FORCE_CLICK);
        qaLocatorResultReportRepository.save(qaLocatorResultReport);
        //reportAction(context, webElement, testLocator.getShortDescription(), testLocator.getIdentifier(), locatorGroupData.isTakeAScreenshot());
