...
//    private SubsidiaryRepository subsidiaryRepository;
    ...
    public Dashboard getDashboardByIdentifier(String id) {
        return dashboardRepository.findByIdentifier(id);
    }
    ...
    public DashboardForm edit(DashboardForm dashboardForm) {
        ...
        Dashboard dashboardRec = dashboardRepository.findByIdentifier(dashboard.getIdentifier());
    ...
    public DashboardWsDto handleEdit(DashboardWsDto request) {
        ...
        for (DashboardDto dashboard : dashboards) {
            if (dashboard.isAdd() && baseService.validateIdentifier(EntityConstants.DASHBOARD, dashboard.getIdentifier()) != null) {
                request.setSuccess(false);
                request.setMessage("Identifier already present");
                return request;
            }
            if (dashboard.getIdentifier() != null) {
                requestData = dashboardRepository.findByIdentifier(dashboard.getIdentifier());
        ...
        dashboardWsDto.setDashboards(modelMapper.map(dashboardList, listType));
        dashboardWsDto.setMessage("Dashboard updated successfully");
    ...
    public void getTestResultForLastNDays(Dashboard dashboard, QaSummaryData qaSummaryData, String subsidiaryId, String days, String runner) {
        ...
        for (QATestResult testResult : qaTestResultList) {
            ...
            //TODO FIX the id
//            Subsidiary subsidiary = subsidiaryRepository.findByIdentifier(testResult.getIdentifier());
//            if (subsidiary != null) {
...
//            }
    ...
    private void populateCategorySections(Dashboard dashboard, Map<String, Set<String>> errorMap, Map<String, Map<String, Set<String>>> issuesMap) {
        ...
        if (recordId == null) {
            ...
            DashboardProfile dashboardProfile = dashboardProfileService.getDashboardProfileByIdentifier(dashboard.getDashboardProfile());
