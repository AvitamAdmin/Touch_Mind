 ...
 */
                ...
                .authorizeHttpRequests((requests) -> {
                            try {
                                requests
                                        ...
                                        .requestMatchers("/css/**", "/images/**", "/vendors/**", "/api/**", "/maps/**", "/resources/**", "/register", "/login", "/forgotpassword", "/resetpassword", "/handleUploadOperation", "/registrationConfirm", "/otplogin", "/swagger-ui/**", "/v3/**", "/admin/role/get", "/admin/subsidiary/get", "/impex/**", "/reports/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList(env.getProperty(SERVER_URL), "http://localhost:3000", env.getProperty(SERVER_UI_URL))); // Allow the specific origin
